...
2. 在使用 vLLM Ascend 时，如果想要开启 V1 引擎，需要通过环境变量手动配置。

   ```shell
   export VLLM_USE_V1=1
   ```

3. torch-npu 的 2.5.1.post1.dev20250528 版本安装方式如下：

   ```shell
   export PIP_EXTRA_INDEX_URL=https://mirrors.huaweicloud.com/ascend/repos/pypi
   pip install torch_npu==2.5.1.post1.dev20250528
   ```
...
| Reinforce Baseline               | 验证中         |           | 2.5.1      | 2.5.1.post1.dev20250528 | 8.1.RC1   |                                                              |
| DAPO                             | 验证中         |           | 2.5.1      | 2.5.1.post1.dev20250528 | 8.1.RC1   |                                                              |
